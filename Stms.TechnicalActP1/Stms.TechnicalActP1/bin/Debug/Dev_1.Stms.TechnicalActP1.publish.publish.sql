...
(
	SELECT
		...
		IIF(YEAR(saj.REPAIRSOENDDATEASUT) = 1900,
			NULL, DATEADD(hour, CAST('$(UTC_OFFSET)' AS int), saj.REPAIRSOENDDATEASUT)) AS REPAIRSOENDDATEASUT,
		DATEADD(hour, CAST('$(UTC_OFFSET)' AS int), saj.REGISTRATIONSODATE) AS REGISTRATIONSODATE_sort
